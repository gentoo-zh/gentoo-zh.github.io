...
overlay 倉庫即將遷移到組織倉庫 `Gentoo-zh/gentoo-zh`，見[公告與執行方案](/posts/2026-07-02-gentoo-zh-repo-migration/)。貢獻者牆的自動統計已提前指向新倉庫（下次自動更新在 8 月，屆時遷移已完成）；本頁 fork、issue 等教學連結仍指向 `microcai/gentoo-zh`，遷移完成後同步更新，舊地址屆時會自動跳轉。
{{< /callout >}}
